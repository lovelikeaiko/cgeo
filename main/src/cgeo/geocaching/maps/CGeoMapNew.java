 ...
 */
public class CGeoMapNew extends AppCompatAbstractMap implements ViewFactory {
    ...
    private static final class DisplayHandler extends Handler {
        ...
        private final WeakReference<CGeoMapNew> mapRef;

        DisplayHandler(@NonNull final CGeoMapNew map) {
            this.mapRef = new WeakReference<>(map);
        }
        @Override
        public void handleMessage(final Message msg) {
            final CGeoMapNew map = mapRef.get();
            if (map == null) {
                return;
            }
    ...
    private static final class ShowProgressHandler extends Handler {
        ...
        @NonNull private final WeakReference<CGeoMapNew> mapRef;

        ShowProgressHandler(@NonNull final CGeoMapNew map) {
            this.mapRef = new WeakReference<>(map);
        }
    ...
    public CGeoMapNew(final AppCompatMapActivityImpl activity) {
        super(activity);
    }
            ...
            switch (msg.what){
                ...
                case MAIN_THREAD_LOAD:
                    ...
                    if (getLatitudeSpan()<900000){
                        loadExecutor.execute(new CGeoMapNew.LoadRunnable(CGeoMapNew.this));
                    }else{
        ...
        if (!toRefresh.isEmpty()) {
            AndroidRxUtils.refreshScheduler.scheduleDirect(new Runnable() {
                ...
                public void run() {
                    ...
                    displayExecutor.execute(new DisplayRunnable(CGeoMapNew.this));
                }
            });
        }
    }
...
//        mapView.destroyDrawingCache();
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        ...
        try {
            ...
            Log.e("CGeoMapNew.onPrepareOptionsMenu", e);
        }
    ...
    private static class UpdateLoc extends GeoDirHandler {
        ...
        UpdateLoc(final CGeoMapNew map) {
    ...
    private static final class LoadTimerAction implements Runnable {
        ...
        LoadTimerAction(@NonNull final CGeoMapNew map) {
            this.mapRef = new WeakReference<>(map);
        }
        ...
        public void run() {
            ...
            try {
                ...
                Log.w("CGeoMapNew.startLoadtimer.start", e);
            }
        }
    }
    ...
    private static class LoadRunnable extends DoRunnable {
        ...
        LoadRunnable(@NonNull final CGeoMapNew map) {
            super(map);
        }

        @Override
        public void runWithMap(final CGeoMapNew map) {
            map.doLoadRun();
        }
    }
...
//            showProgressHandler.sendEmptyMessage(HIDE_PROGRESS); // hide progress
    ...
    private static class DownloadRunnable extends DoRunnable {
        ...
        DownloadRunnable(final CGeoMapNew map) {
            super(map);
        }
...
//            showProgressHandler.sendEmptyMessage(HIDE_PROGRESS); // hide progress
    ...
    private static class DisplayRunnable extends DoRunnable {
        ...
        DisplayRunnable(@NonNull final CGeoMapNew map) {
            super(map);
        }
...
//            showProgressHandler.sendEmptyMessage(HIDE_PROGRESS);
    ...
    private abstract static class DoRunnable implements Runnable {
        ...
        protected DoRunnable(@NonNull final CGeoMapNew map) {
            mapRef = new WeakReference<>(map);
        }
        ...
        protected abstract void runWithMap(final CGeoMapNew map);
    }
        ...
        waitDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(final DialogInterface arg0) {
                try {
                    ...
                    Log.e("CGeoMapNew.storeCaches.onCancel", e);
                }
            }
        });
        ...
        public void run() {
            ...
            for (final String geocode : geocodes) {
                try {
                    ...
                    Log.e("CGeoMapNew.LoadDetails.run", e);
                } finally {
                    // one more cache over
                    detailProgress++;
    ...
    private static class MyLocationListener implements View.OnClickListener {
        ...
        MyLocationListener(@NonNull final CGeoMapNew map) {
            mapRef = new WeakReference<>(map);
        }
    ...
    public static class MapDragListener implements OnMapDragListener {
        ...
        public MapDragListener(@NonNull final CGeoMapNew map) {
            mapRef = new WeakReference<>(map);
        }
